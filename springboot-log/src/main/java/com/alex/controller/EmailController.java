...
public class EmailController {
    ...
    public String sendSimpleEmail() {
        try {
            ...
            message.setTo("yanhuihui@daokoudai.com"); // 接收地址
    ...
    public String sendHtmlEmail() {
        ...
        try {
            ...
            helper.setFrom(from);
            helper.setTo("yanhuihui@daokoudai.com"); // 接收地址
    ...
    public String sendAttachmentsMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File("/Users/yanhuihui/Downloads/金蝶税采通.patch"));
